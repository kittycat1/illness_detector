...
class IllnessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create illness" do
    assert_difference('Illness.count') do
      post illnesses_url, params: { illness: { content: @illness.content, name: @illness.name } }
    end
  ...
  test "should update illness" do
    patch illness_url(@illness), params: { illness: { content: @illness.content, name: @illness.name } }
